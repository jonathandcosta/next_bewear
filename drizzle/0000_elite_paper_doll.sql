CREATE TABLE "catogory" (
	...
	CONSTRAINT "catogory_slug_unique" UNIQUE("slug")
);
...
--> statement-breakpoint
ALTER TABLE "product" ADD CONSTRAINT "product_category_id_catogory_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."catogory"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
